...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 08, 2021 at 04:42 AM
...
--
-- Table structure for table `tblflows`
--
...
INSERT INTO `tblsubjects` (`Id`, `CountryId`, `Name`, `IsActive`, `CreatedBy`, `ModifiedBy`, `CreatedOn`, `ModifiedOn`, `IsDeleted`) VALUES
(2, 1, 'Test', 1, 1, NULL, '0000-00-00 00:00:00', NULL, 0);
...
INSERT INTO `tblusers` (`Id`, `Name`, `Email`, `Username`, `Password`, `RoleId`, `IsActive`) VALUES
(1, 'Namit Kapoor', 'admin@gmail.com', 'admin', 'E6E061838856BF47E1DE730719FB2609', 1, 1);
...
--
-- Indexes for table `tblflows`
--
ALTER TABLE `tblflows`
  ADD PRIMARY KEY (`Id`);
...
--
-- AUTO_INCREMENT for table `tblflows`
--
ALTER TABLE `tblflows`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT;
