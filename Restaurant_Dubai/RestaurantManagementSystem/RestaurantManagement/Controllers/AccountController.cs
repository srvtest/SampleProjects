...
namespace RestaurantManagement.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(RestaurantUser objRestaurantUserModel)
        {
            ...
            try
            {
                if (objRestaurantUserModel != null)
                {
                    ...
                    if (objApiResponse.StatusCode == 0 && objApiResponse.Result != null)
                    {
                        ...
                        {
                            rs.RoleId = Convert.ToInt32(ds.Tables[0].Rows[0]["RolesID"]);
                            rs.Firstname = Convert.ToString(ds.Tables[0].Rows[0]["Firstname"]);
                            rs.LastName = Convert.ToString(ds.Tables[0].Rows[0]["LastName"]);
                            rs.Email = Convert.ToString(ds.Tables[0].Rows[0]["Email"]);
                            rs.RoleName = Convert.ToString(ds.Tables[0].Rows[0]["RoleName"]);
                            rs.MenuAccess = Convert.ToString(ds.Tables[0].Rows[0]["MenuAccess"]);
                            rs.MenuAccessID = Convert.ToString(ds.Tables[0].Rows[0]["MenuAccessID"]);
                            rs.UserID = Convert.ToInt32(ds.Tables[0].Rows[0]["UserID"]);

                            rs.RestaurentId = Convert.ToInt32(ds.Tables[0].Rows[0]["RestaurantID"]);
                            rs.RestaurentName = Convert.ToString(ds.Tables[0].Rows[0]["Name"]);
                            rs.Logo = Convert.ToString(ds.Tables[0].Rows[0]["Logo"]);
                            Session["RSession"] = rs;
        ...
        public ActionResult SendEmail(string emailTo, string suject, string body)
        {
            try
            {
                ...
                return View("Mail sent successfully.");
            }
            catch (Exception e)
            {
