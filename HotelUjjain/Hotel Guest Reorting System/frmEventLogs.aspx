<%@ Page Title="" Language="C#" MasterPageFile="~/mainHome.Master" AutoEventWireup="true" CodeBehind="frmEventLogs.aspx.cs" Inherits="Hotel_Guest_Reporting_System.frmEventLogs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        ...
        <asp:HiddenField ID="hdEventLogId" runat="server" Value="0" />
        <div class="row">
            <div class="col-sm-12 p-0">
                <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="<%=this.Master.baseUrl %>frmEventLogs.aspx">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="word-break: break-all;">
                                                <asp:HiddenField ID="hdId" runat="server" Value='<%# Eval("idEventLog") %>' />
                                                <%#Eval("MethodName")%>
                                            </td>
                                            <td style="word-break: break-all;">
                                                <span class="shortText">
                                                    <%# Eval("Parameter").ToString().Length > 40 ? Eval("Parameter").ToString().Substring(0, 40) + "..." : Eval("Description") %>
                                                </span>
                                                <span class="fullText" style="display: none;">
                                                    <%# Eval("Parameter") %>
                                                </span>
                                                <%#(String.IsNullOrEmpty(Eval("Parameter").ToString()) ? "" : "<a href=\"javascript:void(0);\" onclick=\"toggleText(this)\">Read More</a>")%>
                                                <%-- <%#Eval("Parameter")%>--%>
                                            </td>
                                            <td style="word-break: break-all;"><%#Eval("ProcName")%></td>
