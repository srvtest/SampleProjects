<%@ Page Title="" Language="C#" MasterPageFile="~/mainHome.Master" AutoEventWireup="true" CodeBehind="frmDistrictMaster.aspx.cs" Inherits="Hotel_Guest_Reporting_System.frmDistrictMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        ...
        <asp:HiddenField ID="hdDistrictId" runat="server" Value="0" />
        <div class="row">
            <div class="col-sm-12 p-0">
                <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="<%=this.Master.baseUrl %>frmDistrictMaster.aspx">
        ...
        <div class="row" runat="server" id="pnluserList">
            <div class="col-sm-12">
                ...
                <div class="card" runat="server" id="tblDistrict">
                                ...
                                <asp:Repeater ID="RptUser" runat="server" OnItemCommand="RptUser_ItemCommand">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblsName" runat="server" ClientIDMode="Static" Text='<%#Eval("DistrictName")%>'></asp:Label>
                                            </td>
                                            <%--<td><%#Eval("CityName")%></td>--%>
                                            <td><%#Eval("stateName")%></td>
                                            <td>

                                                <asp:HiddenField ID="hdId" runat="server" Value='<%# Eval("idDistrict") %>' />

                                                <asp:Button ID="Button1" runat="server" Text="Edit" class="btn btn-guestsuccess waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Edit" CommandArgument='<%# Eval("idDistrict") %>' CommandName="Update" />
                                                <asp:Button ID="Button2" runat="server" Text="Delete" class="btn btn-default waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Delete" CommandArgument='<%# Eval("idDistrict") %>' CommandName="Delete" />
                                                <asp:Button ID="Button3" runat="server" Text="View" class="btn btn-guestsuccess waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="View" CommandArgument='<%# Eval("idDistrict") %>' CommandName="View" />
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
                ...
                <div class="card" runat="server" id="pnlUser">
                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtDistrictname" runat="server" CssClass="form-control" placeholder="Enter District name"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" CssClass="fontcolour" runat="server" ControlToValidate="txtDistrictname" ErrorMessage="Please select District" ValidationGroup="save"></asp:RequiredFieldValidator>
                        </div>
                        <div class="form-group">
