...
{
    public partial class frmErrorLogs : System.Web.UI.Page
    {
        ErrorLogDL objCityDL = new ErrorLogDL();
        List<ErrorLogDto> userDto
        {
            get
            {
                return (List<ErrorLogDto>)Session["ErrorLog"];
            }
            set
            {
                Session["ErrorLog"] = value;
            }
        }
        protected void Page_Load(object sender, EventArgs e)
        {
            lbl1.Text = "ErrorLogs Details";
            lbl2.Text = "ErrorLogs";
            lbl3.Text = lbl2.Text;
            if (!Page.IsPostBack)
            {
        ...
        {
            ResponseDto obj = objCityDL.GetErrorLog();
            if (obj != null)
            {
                if (obj.StatusCode == 0)
                {
                    userDto = (List<ErrorLogDto>)obj.Result;                    
                }
            }
            ShowUserPanal(false);
        ...
        //{
        //    ErrorLogDto userDto = new ErrorLogDto();
        //    userDto.isDeleted = true;
        //    if (!string.IsNullOrEmpty(hdnId.Value))
        //    {
        //        userDto.idErrorLog = Convert.ToInt32(hdnId.Value);
        //    }

        //    ResponseDto response = objCityDL.InsertUpdateDeleteErrorLog(userDto);
        //    if (response != null)
        //    {
        ...
        //{
        //    ErrorLogDto userDto = new ErrorLogDto();
        //    userDto.Method = TextBox1.Text;
        //    userDto.ErrorMessage = TextBox2.Text;
        //    userDto.ErrorType = TextBox3.Text;
        //    userDto.dtCreated = Convert.ToDateTime(TextBox4.Text);
        //    if (!string.IsNullOrEmpty(hdErrorLogsId.Value))
        //    {
        //        userDto.idErrorLog = Convert.ToInt32(hdErrorLogsId.Value);
        //    }
