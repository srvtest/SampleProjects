<%@ Page Title="" Language="C#" MasterPageFile="~/mainHome.Master" AutoEventWireup="true" CodeBehind="frmErrorLogs.aspx.cs" Inherits="Hotel_Guest_Reporting_System.frmErrorLogs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        ...
        <asp:HiddenField ID="hdErrorLogsId" runat="server" Value="0" />
        <div class="row">
            <div class="col-sm-12 p-0">
                <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="<%=this.Master.baseUrl %>frmErrorLogs.aspx">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="word-break: break-all;">
                                                <asp:HiddenField ID="hdId" runat="server" Value='<%# Eval("idErrorLog") %>' />
                                                <asp:Label ID="lblsName" runat="server" ClientIDMode="Static" Text='<%#Eval("Method")%>'></asp:Label>
                                            </td>
                                            <td style="word-break: break-all;">
                                                <%--<asp:Label ID="lblDistrictName" runat="server" ClientIDMode="Static" Text='<%#Eval("ErrorMessage")%>'></asp:Label>--%>
                                                <span class="shortText">
                                                    <%# Eval("ErrorMessage").ToString().Length > 40 ? Eval("ErrorMessage").ToString().Substring(0, 40) + "..." : Eval("ErrorMessage") %>
                                                </span>
                                                <span class="fullText" style="display: none;">
                                                    <%# Eval("ErrorMessage") %>
                                                </span>
                                                <%#(String.IsNullOrEmpty(Eval("ErrorMessage").ToString()) ? "" : "<a href=\"javascript:void(0);\" onclick=\"toggleText(this)\">Read More</a>")%>                                     
                                            </td>
                                            <td style="word-break: break-all;"><%#Eval("ErrorType")%></td>
                                            <td style="word-break: break-all;"><%#Eval("dtCreated").ToString() == "1/1/0001 12:00:00 AM" ? "" : String.Format("{0:dd/MM/yy HH:mm}", Eval("dtCreated")) %></td>
                                            <%--<td>
