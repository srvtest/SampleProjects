<%@ Page Title="" Language="C#" MasterPageFile="~/mainHome.Master" AutoEventWireup="true" CodeBehind="frmNotificationLogs.aspx.cs" Inherits="Hotel_Guest_Reporting_System.frmNotificationLogs" %>
            ...
            <div class="col-sm-12 p-0">
                <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="<%=this.Master.baseUrl %>frmNotificationLogs.aspx">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="word-break: break-all;">
                                                <asp:HiddenField ID="hdId" runat="server" Value='<%# Eval("NotificationLogsID") %>' />
                                            ...
                                            <td style="word-break: break-all;">
                                                ...
                                                <span class="shortText">
                                                    <%# Eval("Message").ToString().Length > 40 ? Eval("Message").ToString().Substring(0, 40) + "..." : Eval("Message") %>
                                                </span>
                                                <span class="fullText" style="display: none;">
                                                    <%# Eval("Message") %>
                                                </span>
                                                <%#(String.IsNullOrEmpty(Eval("Message").ToString()) ? "" : "<a href=\"javascript:void(0);\" onclick=\"toggleText(this)\">Read More</a>")%>                                                
                                            </td>
                                            <td style="word-break: break-all;">
                                                <%--<%#Eval("ResponseBody")%>--%>
                                                <span class="shortText">
                                                    <%# Eval("UserType").ToString().Length > 40 ? Eval("UserType").ToString().Substring(0, 40) + "..." : Eval("UserType") %>
                                                </span>
                                                <span class="fullText" style="display: none;">
                                                    <%# Eval("UserType") %>
                                                </span>
                                                <%#(String.IsNullOrEmpty(Eval("UserType").ToString()) ? "" : "<a href=\"javascript:void(0);\" onclick=\"toggleText(this)\">Read More</a>")%> 
                                            </td>
                                            <td style="word-break: break-all;"><%#Eval("CreatedAt").ToString() == "1/1/0001 12:00:00 AM" ? "" : String.Format("{0:dd/MM/yy HH:mm}", Eval("CreatedAt")) %></td>
                                            <%--<td>
