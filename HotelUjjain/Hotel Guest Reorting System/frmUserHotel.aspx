<%@ Page Title="" Language="C#" MasterPageFile="~/mainHome.Master" AutoEventWireup="true" CodeBehind="frmUserHotel.aspx.cs" Inherits="Hotel_Guest_Reporting_System.frmUserHotel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        ...
        <asp:HiddenField ID="hdUserHotelId" runat="server" Value="0" />
        <div class="row">
            <div class="col-sm-12 p-0">
                <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="<%=this.Master.baseUrl %>frmUserHotel.aspx">
        ...
        <div class="row" runat="server" id="pnluserList">
            <div class="col-sm-12">
                ...
                <div class="card" runat="server" id="tblUserHotel">
                                ...
                                <asp:Repeater ID="RptUser" runat="server" OnItemCommand="RptUser_ItemCommand">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:HiddenField ID="hdHotelId" runat="server" Value='<%# Eval("idUserHotel") %>' />
                      ...
                      <code>width: 100%;</code> by default.Labels and controls in <code>.form-group</code> for optimum spacing.
                        ...
                        <form>
                            <div class="form-group">
                                <label for="exampleInputEmail" class="form-control-label">User Name</label>
                                <asp:DropDownList ID="ddlUserId" runat="server" class="form-control"></asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" CssClass="fontcolour" runat="server" ControlToValidate="txtlabel" ErrorMessage="Please select user" ValidationGroup="save"></asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword" class="form-control-label">Hotel Name</label>
                                <asp:DropDownList ID="ddlHotelId" runat="server" class="form-control"></asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" CssClass="fontcolour" runat="server" ControlToValidate="txtlabel" ErrorMessage="Please select hotel" ValidationGroup="save"></asp:RequiredFieldValidator>
                            </div>
                            <div class="">
                            ...
                            <asp:Button ID="btnSubmit" runat="server" Text="Save" class="btn btn-success waves-effect waves-light m-r-30" data-toggle="tooltip" data-placement="top" title="Save" OnClick="btnSubmit_Click" ValidationGroup="save"/>
