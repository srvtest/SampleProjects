...
{
    public partial class frmRequestResponseLogs : System.Web.UI.Page
    {
        RequestResponseLogDL objCityDL = new RequestResponseLogDL();
        List<RequestResponseLogDto> userDto
        {
            get
            {
                return (List<RequestResponseLogDto>)Session["RequestResponseLog"];
            }
            set
            {
                Session["RequestResponseLog"] = value;
            }
        }
        protected void Page_Load(object sender, EventArgs e)
        {
            lbl1.Text = "RequestResponseLog Details";
            lbl2.Text = "RequestResponseLog";
            lbl3.Text = lbl2.Text;
            if (!Page.IsPostBack)
            {
        ...
        {
            ResponseDto obj = objCityDL.GetRequestResponseLog();
            if (obj != null)
            {
                if (obj.StatusCode == 0)
                {
                    userDto = (List<RequestResponseLogDto>)obj.Result;
                }
            }
            ShowUserPanal(false);
        ...
        //{
        //    lbl4.Text = "Add RequestResponseLog";
        //    ShowUserPanal(true);
        //    //BindStateDropdown();
        //    EnableDisableControl(true);
        //}
        ...
        //{
        //    RequestResponseLogDto userDto = new RequestResponseLogDto();
        //    userDto.isDeleted = true;
        //    if (!string.IsNullOrEmpty(hdnId.Value))
        //    {
        //        userDto.RequestResponseLogId = Convert.ToInt32(hdnId.Value);
        //    }

        //    ResponseDto response = objCityDL.InsertUpdateDeleteRequestResponseLog(userDto);
        //    if (response != null)
        //    {
        ...
        //    if (!string.IsNullOrEmpty(hdRequestResponseLogId.Value))
        //    {
        //        userDto.idEventLog = Convert.ToInt32(hdRequestResponseLogId.Value);
        //    }
