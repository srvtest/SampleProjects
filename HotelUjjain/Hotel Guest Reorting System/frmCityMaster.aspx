<%@ Page Title="" Language="C#" MasterPageFile="~/mainHome.Master" AutoEventWireup="true" CodeBehind="frmCityMaster.aspx.cs" Inherits="Hotel_Guest_Reporting_System.frmCityMaster" %>
            ...
            <div class="col-sm-12 p-0">
                <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="<%=this.Master.baseUrl %>frmCityMaster.aspx">
                                ...
                                <asp:Repeater ID="RptUser" runat="server" OnItemCommand="RptUser_ItemCommand">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblsName" runat="server" ClientIDMode="Static" Text='<%#Eval("CityName")%>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblDistrictName" runat="server" ClientIDMode="Static" Text='<%#Eval("DistrictName")%>'></asp:Label>
                                            </td>
                                            <td><%#Eval("stateName")%></td>
                                            <td>

                                                <asp:HiddenField ID="hdId" runat="server" Value='<%# Eval("CityID") %>' />

                                                <asp:Button ID="Button1" runat="server" Text="Edit" class="btn btn-guestsuccess waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Edit" CommandArgument='<%# Eval("CityID") %>' CommandName="Update" />
                                                <asp:Button ID="Button2" runat="server" Text="Delete" class="btn btn-default waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Delete" CommandArgument='<%# Eval("CityID") %>' CommandName="Delete" />
                                                <asp:Button ID="Button3" runat="server" Text="View" class="btn btn-guestsuccess waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="View" CommandArgument='<%# Eval("CityID") %>' CommandName="View" />
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
                ...
                <div class="card" runat="server" id="pnlUser">
                    ...
                    <div class="card-block">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlStateId" runat="server" ClientIDMode="Static" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlStateId_SelectedIndexChanged"></asp:DropDownList>
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlDistrict" runat="server" ClientIDMode="Static" CssClass="form-control"></asp:DropDownList>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtCityname" runat="server" CssClass="form-control" ClientIDMode="Static" placeholder="Enter City name"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" CssClass="fontcolour" runat="server" ControlToValidate="txtCityname" ErrorMessage="Please enter city name" ValidationGroup="save"></asp:RequiredFieldValidator>
                        </div>
                        <div class="form-group">
