<%@ Page Title="" Language="C#" MasterPageFile="~/mainHome.Master" AutoEventWireup="true" CodeBehind="frmPropertyType.aspx.cs" Inherits="Hotel_Guest_Reporting_System.frmPropertyType" %>
            ...
            <div class="col-sm-12 p-0">
                <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="<%=this.Master.baseUrl %>frmPropertyType.aspx">
                                ...
                                <asp:Repeater ID="RptUser" runat="server" OnItemCommand="RptUser_ItemCommand">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblsName" runat="server" ClientIDMode="Static" Text='<%#Eval("PropertyType")%>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:HiddenField ID="hdId" runat="server" Value='<%# Eval("idProperty") %>' />
                                                <asp:Button ID="Button1" runat="server" Text="Edit" class="btn btn-guestsuccess waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Edit" CommandArgument='<%# Eval("idProperty") %>' CommandName="Update" />
                                                <asp:Button ID="Button2" runat="server" Text="Delete" class="btn btn-default waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Delete" CommandArgument='<%# Eval("idProperty") %>' CommandName="Delete" />
                                                <asp:Button ID="Button3" runat="server" Text="View" class="btn btn-guestsuccess waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="View" CommandArgument='<%# Eval("idProperty") %>' CommandName="View" />
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
                ...
                <div class="card" runat="server" id="pnlUser">
                    ...
                    <div class="card-block">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtPropertyType" runat="server" CssClass="form-control" ClientIDMode="Static" placeholder="Enter Property Type"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" CssClass="fontcolour" runat="server" ControlToValidate="txtPropertyType" ErrorMessage="Please enter Property Type" ValidationGroup="save"></asp:RequiredFieldValidator>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="frmPropertyType.aspx" class="btn btn-default me-2">No</a>
