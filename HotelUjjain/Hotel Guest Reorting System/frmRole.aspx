<%@ Page Title="" Language="C#" MasterPageFile="~/mainHome.Master" AutoEventWireup="true" CodeBehind="frmRole.aspx.cs" Inherits="Hotel_Guest_Reporting_System.frmRole" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        ...
        <asp:HiddenField ID="hdRoleId" runat="server" Value="0" />
        <div class="row">
            <div class="col-sm-12 p-0">
                <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="<%=this.Master.baseUrl %>frmRole.aspx">
                                ...
                                <asp:Repeater ID="RptRole" runat="server" OnItemCommand="RptRole_ItemCommand">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <%#Eval("sname")%>
                                                <asp:HiddenField ID="hduserId" runat="server" Value='<%# Eval("idRole") %>' />
                                            </td>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="frmRole.aspx" class="btn btn-default me-2">No</a>
