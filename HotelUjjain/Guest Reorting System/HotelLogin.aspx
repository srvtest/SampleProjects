<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HotelLogin.aspx.cs" Inherits="Guest_Reporting_System.HotelLogin" %>
...
<%--                <p class="login-box-msg" style="font-size: 15px; font-family: math;"><b>Hotel Login</p>--%>
                ...
                <div id="spnPlan" runat="server" visible="false" class="alert alert-danger alert-primary">                    
</div>
                ...
                <div class="form-group has-feedback" style="margin-top: 50px;">
                   ...
                   <%-- <p style="text-align-last: center;margin-top: 15px;"">Our Continue WIth</p>
                    ...
                    <p style="text-align-last: center; margin-top: 15px;">
                        Don’t have an account? <a href="HotelRegistration.aspx"><b style="text-decoration-color: #1AA7FF">New Hotel registration</b></a>
                    </p>
                </div>
        ...
        <script>
            ...
            setTimeout(function () {
                $("#spnPlan").fadeTo(2000, 500).slideUp(500, function () {
                    $("#spnPlan").remove();
                  //  $("#spnmsg").hide();
                  //  $("#spnmsgSuccess").hide();
                });
