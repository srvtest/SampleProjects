<%@ Page Title="" Language="C#" MasterPageFile="~/HotelMain.Master" AutoEventWireup="true" CodeBehind="Important.aspx.cs" Inherits="Guest_Reporting_System.Important" %>
            ...
            <div class="box box-primary">
                <div class="card-body">
                    <h4 class="box-header with-border">
                        <asp:Label ID="lbl4" runat="server">महत्वपूर्ण जानकारी</asp:Label>
...
GuestReport.in होटलों द्वारा सबमिट की गई अतिथि जानकारी की सामग्री या सटीकता के लिए जिम्मेदार नहीं है। </li>
                                            <li>विस्तृत नियम एवं शर्तों के लिए <a href="TermsConditions.aspx">नियम एवं शर्तें पृष्ठ पर जाएं।</a></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
