...
namespace Police_Station_Reporting_System
{
    public partial class GuestDetails : System.Web.UI.Page
    {
        ...
        public void LoadGridData()
        {
            ...
            ResponseDto obj = objuserDL.GetGuestDetailByPoliceStationId(guestFilterDto);
            if (obj != null)
            {
                if (obj.StatusCode == 0)
                {
        ...
        protected void rptGuest_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
                           ...
                           e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                HiddenField hdnADD = e.Item.FindControl("hdnAdd") as HiddenField;
        ...
        protected void rptGuest_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "Details")
            {
                ...
                Response.Redirect("SubmitDetail.aspx?idHotel=" + UtilityFunction.Encrypt(Convert.ToString(hdnIdHotel_1.Value)) + "&SubmitDate=" + UtilityFunction.Encrypt(Convert.ToString(hdnSubDate_1.Value)));
            }
        }
