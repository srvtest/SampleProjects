<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="SearchGuests.aspx.cs" Inherits="Police_Station_Reporting_System.SearchGuests" %>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>नाम </label>
                                    <asp:TextBox ID="txtName" runat="server" class="form-control" placeholder="नाम"></asp:TextBox>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtContact" runat="server" class="form-control" placeholder="मोबाइल नंबर"></asp:TextBox>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtAdhar" runat="server" class="form-control" placeholder="आईडी नंबर"></asp:TextBox>
                            ...
                            <div class="col-md-3" style="padding-top: 25px;">
                                <div class="form-group">
                                    <asp:Button ID="Button1" runat="server" Text="सर्च गेस्ट" class="btn btn-primary me-2" OnClick="btnSearch_Click" />
                                </div>
                            </div>
                        </div>
                        <%-- <div>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                           ...
                                           <%-- <td><%#Eval("Address")%></td>--%>
                                            ...
                                            <td>
                                                <asp:Button ID="btnDetails" runat="server" Text="विवरण" class="btn btn-primary" CommandName="Details" /></td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        </tbody>
