...
{
   public class RoomPlanCls
    {
    public int Id { get; set; }
    public string RoomPlanName { get; set; }
        ...
        public RoomPlanCls(DataRow dr)
        {
            if (dr.Table.Columns.Contains("Id") && !Convert.IsDBNull(dr["Id"]))
                this.Id = Convert.ToInt32(dr["Id"]);

            if (dr.Table.Columns.Contains("RoomPlanName") && !Convert.IsDBNull(dr["RoomPlanName"]))
                this.RoomPlanName = Convert.ToString(dr["RoomPlanName"]);
