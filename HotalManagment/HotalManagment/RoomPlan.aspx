<%@ Page Title="" Language="C#" MasterPageFile="~/Main1.Master" AutoEventWireup="true" CodeBehind="RoomPlan.aspx.cs" Inherits="HotalManagment.RoomPlan" %>
    ...
    <div class="page-content">
                            ...
                            <div class="card-body ">
                                <div class="table-scrollable">
                                    ...
                                    <asp:GridView ID="grdCategory" runat="server" ClientIDMode="Static" AutoGenerateColumns="false"
                                        Width="100%" OnRowEditing="grdCategory_RowEditing" class="table">
                                        <Columns>
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="RoomPlan">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCategoryName" runat="server" Text="<%#Bind('RoomPlanName')%>"></asp:Label>
        ...
        <div id="pnlEdit" runat="server" class="row" clientidmode="Static" style="display:none">
            <div class="col-sm-12">
                <div class="card-box">
                    <div class="card-head">
                        <header>Add / Update Room Plan</header>
                    </div>
                    <div class="card-body row">
                        <div class="col-lg-6 p-t-20">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                <asp:TextBox ID="txtRoomPlan" runat="server" class="mdl-textfield__input" name="password"
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Required" ValidationGroup="G1"
                                    ControlToValidate="txtRoomPlan" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>
