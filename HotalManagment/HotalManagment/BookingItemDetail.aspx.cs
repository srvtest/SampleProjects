...
{
    public partial class BookingItemDetail : System.Web.UI.Page
    {
        ...
        protected void grdBookedItem_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            //    if (((System.Data.DataRowView)(e.Row.DataItem)).Row.ItemArray[4].Equals(1))
            //    {
        ...
        protected void ddRoomList_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddRoomList.SelectedValue != "0")
            {
                ...
                getBookedItemByBookingId();
                lblRommNo.Text = ddRoomList.SelectedItem.Text;
                getAllItem();
