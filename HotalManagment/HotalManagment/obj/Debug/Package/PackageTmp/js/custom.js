...
$(document).ready(function(){
    ...
    $(".datepickerFrom").datepicker({
        ...
        onSelect: function(selected) {
          ...
          $(".datepickerCheckin").datepicker("option","minDate", selected)
        }
    });
    ...
    //$("#grdContactInfo tr:last-child").show();
        var fName = $('.txtFirstName').val();    
        var lName = $('.txtLastName').val();   
        var age = $('.txtAge').val();   
        var gender = $('.rbtnGender').val();   
        
//        var row = $("#grdContactInfo tr:last-child").clone(true);
//        //$("#grdContactInfo tr").not($("#grdContactInfo tr:first-child")).remove();
//        
//            $("td", row).eq(0).html(fName);
//            $("td", row).eq(1).html(lName);
//            $("td", row).eq(2).html(age);
//            $("#grdContactInfo").append(row);
//            row = $("#grdContactInfo tr:last-child").clone(true);
//            $("#grdContactInfo tr:nth-child(2)").hide(); 



//            $("#grdContactInfo").append("<tr><th>First Name</th> <th>Last Name</th><th>Age</th></tr>");

//                        for (var i = 0; i < data.d.length; i++) {

//                            $("#grdContactInfo").append("<tr><td>" +

//                        data.d[i].ProductID + "</td> <td>" +

//                        data.d[i].ProductName + "</td> <td>" +

//                        data.d[i].QuantityPerUnit + "</td> <td>" +
...
//                        }
    ...
    //$("#grdContactInfo tr:last-child").hide();
...
function template_functions(){
    ...
    $('.btn-Rooms').click(function (e) {
        e.preventDefault();
        $('#AddRooms').modal('show');
          $("[id*=chkStatus] span").addClass("checked", "checked");   
    });
    ...
    $('.btn-Hotel').click(function (e) {
        e.preventDefault();
        $('#AddHotelDeatils').modal('show');
          $("[id*=chkStatus] span").addClass("checked", "checked");   
    });
    ...
    $('.btn-user').click(function (e) {
      ...
      $('.btn-HouseKeeping').click(function (e) {
       e.preventDefault();
       $('#AddUpdateHouseKeeping').modal('show');
         $("[id*=chkStatus] span").addClass("checked", "checked");   
   });
	
      $('.btn-gstSlab').click(function (e) {
       e.preventDefault();
       $('#AddGstSlab').modal('show');
         $("[id*=chkStatus] span").addClass("checked", "checked");   
   });
   $('.btn-businessSource').click(function (e) {
       e.preventDefault();      
       $('#AddBusinessSource').modal('show');  
    $("[id*=chkStatus] span").addClass("checked", "checked");                                
      
   });
   $('.btn-bookingSourceType').click(function (e) {
       e.preventDefault();
       $('#AddBookingSourceType').modal('show');
         $("[id*=chkStatus] span").addClass("checked", "checked");   
   });
   $('.btn-bookingType').click(function (e) {
       e.preventDefault();
       $('#AddBookingType').modal('show');
         $("[id*=chkStatus] span").addClass("checked", "checked");   
   });
   $('.btn-bookingSource').click(function (e) {
       e.preventDefault();
       $('#AddBookingSource').modal('show');
         $("[id*=chkStatus] span").addClass("checked", "checked");   
   });
    ...
    $('.btn-showBooking').click(function (e) {
       e.preventDefault();
       $('#addBooking').modal('show');
         $("[id*=chkStatus] span").addClass("checked", "checked");   
   });
