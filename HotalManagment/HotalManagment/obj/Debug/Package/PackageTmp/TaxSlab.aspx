<%@ Page Title="" Language="C#" MasterPageFile="~/Main1.Master" AutoEventWireup="true" CodeBehind="TaxSlab.aspx.cs" Inherits="HotalManagment.TaxSlab" %>
    ...
    <div class="page-content">
                        ...
                        <div class="card card-topline-green">
                            ...
                            <div class="card-body ">
                                <div class="table-scrollable">
                                    <asp:HiddenField ID="hdTaxSlabId" runat="server" Value="0" />
                                    <asp:GridView ID="grdTaxSlab" runat="server" ClientIDMode="Static" AutoGenerateColumns="false"
                                        Width="100%" OnRowEditing="grdCategory_RowEditing" OnRowDeleting="grdCategory_RowDeleting"
                                        class="table">
                                        <Columns>
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="TaxSlab Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTaxSlabName" runat="server" Text="<%#Bind('TaxSlabName')%>"></asp:Label>
                                                    <asp:HiddenField ID="hdnId" runat="server" Value="<%#Bind('Id') %>" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Start At">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTaxSlabStartAt" runat="server" Text="<%#Bind('StartAt')%>"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="End To">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTaxSlabEndTo" runat="server" Text="<%#Bind('EndTo')%>"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Tax Percent">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTaxPercent" runat="server" Text="<%#Bind('Taxpercent')%>"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
        ...
        <div id="pnlEdit" runat="server" class="row" clientidmode="Static" style="display:none">
            <div class="col-sm-12">
                <div class="card-box">
                    <div class="card-head">
                        <header>Add / Update Tax Slab</header>
                    </div>
                    <div class="card-body row">
                        <div class="col-lg-6 p-t-20">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                <asp:TextBox ID="txtTaxSlab" runat="server" class="mdl-textfield__input"
                                    MaxLength="50"></asp:TextBox>
                                <label class="mdl-textfield__label">
                                    TaxSlab</label>
                            </div>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Required" ValidationGroup="G1"
                                    ControlToValidate="txtTaxSlab" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-lg-6 p-t-20">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                <asp:TextBox ID="txtStartAt" runat="server" class="mdl-textfield__input"  TextMode="Number"
                                   ></asp:TextBox>
                                <label class="mdl-textfield__label">
                                    Start At</label>
                            </div>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Required" ValidationGroup="G1"
                                    ControlToValidate="txtStartAt" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-lg-6 p-t-20">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                <asp:TextBox ID="txtEndTo" runat="server" class="mdl-textfield__input"  TextMode="Number"
                                    ></asp:TextBox>
                                <label class="mdl-textfield__label">
                                    End To</label>
                            </div>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Required" ValidationGroup="G1"
                                    ControlToValidate="txtEndTo" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-lg-6 p-t-20">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                <asp:TextBox ID="txtTaxPercent" runat="server" class="mdl-textfield__input" TextMode="Number"
                                    MaxLength="50"></asp:TextBox>
                                <label class="mdl-textfield__label">
                                    Tax Percent</label>
                            </div>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Required"
                                    ControlToValidate="txtTaxPercent" ForeColor="Red" Display="Dynamic" ValidationGroup="G1"></asp:RequiredFieldValidator>
                        </div>
                        ...
                        <div class="col-lg-12 p-t-20 text-center">
                            <asp:Button ID="btnsave" runat="server" ValidationGroup="G1" Text="Save Tax Slab" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-pink"
