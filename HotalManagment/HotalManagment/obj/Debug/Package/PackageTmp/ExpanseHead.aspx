<%@ Page Title="" Language="C#" MasterPageFile="~/Main1.Master" AutoEventWireup="true" CodeBehind="ExpanseHead.aspx.cs" Inherits="HotalManagment.ExpanseHead" %>
    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li class="active">Expanse Head</li>
                </ol>
            </div>
        </div>
                        ...
                        <div class="card card-topline-green">
                            ...
                            <div class="card-body ">
                                <div class="table-scrollable">
                                    <asp:HiddenField ID="hdExpanseHeadId" runat="server" Value="0" />
                                    <asp:GridView ID="grdExpanseHead" runat="server" ClientIDMode="Static" AutoGenerateColumns="false"
                                        Width="100%" OnRowEditing="grdExpanseHead_RowEditing" 
                                        class="table">
                                        <Columns>
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Expanse Head">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblExpanseHead" runat="server" Text="<%#Bind('ExpanseHead')%>"></asp:Label>
        ...
        <div id="pnlEdit" runat="server" class="row" clientidmode="Static" style="display:none">
            <div class="col-sm-12">
                <div class="card-box">
                    <div class="card-head">
                        <header>Add / Update ExpanseHead</header>
                    </div>
                    <div class="card-body row">
                        <div class="col-lg-6 p-t-20">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                <asp:TextBox ID="txtExpanseHead" runat="server" class="mdl-textfield__input" name="password"
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Required" ValidationGroup="G1"
                                    ControlToValidate="txtExpanseHead" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>
                        ...
                        <div class="col-lg-12 p-t-20 text-center">
                            <asp:Button ID="btnsave" runat="server" ValidationGroup="G1" Text="Save ExpanseHead" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-pink"
