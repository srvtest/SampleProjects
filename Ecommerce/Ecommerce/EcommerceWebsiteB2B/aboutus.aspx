<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="aboutus.aspx.cs" Inherits="EcommerceWebsiteB2B.aboutus" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 tab_menu">
                    <div class="row m0">
                        <ul class="nav navbar-right" role="tablist" id="myTab">
                            <li role="presentation" class="active"><a href="#wwd2018" aria-controls="wwd2018" role="tab" data-toggle="tab">2018</a></li>
                            <li role="presentation"><a href="#wwd2017" aria-controls="wwd2017" role="tab" data-toggle="tab">2017</a></li>
                ...
                <div class="col-sm-6 tab-contents">
                    <asp:HiddenField ID="hdnAboutUsId" runat="server" Value="2" />
                    <asp:Repeater ID="lstAboutUs" runat="server">
                        <HeaderTemplate>
                        </HeaderTemplate>
                        <ItemTemplate>
    ...
    <section id="ourTeam" class="row contentRowPad">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="thumbnail">
                        <img src="<%= this.Master.baseUrl %>images/team/1.png" alt="..." />
                        <div class="caption">
                            <h4>Rues jack</h4>
                            <h5>Founder</h5>
                ...
                <div class="col-sm-3">
                    <div class="thumbnail">
                        <img src="<%= this.Master.baseUrl %>images/team/2.png" alt="..." />
                        <div class="caption">
                            <h4>steve broad</h4>
                            <h5>Co-Founder</h5>
                            <ul class="list-inline row m0">
                ...
                <div class="col-sm-3">
                    <div class="thumbnail">
                        <img src="<%= this.Master.baseUrl %>images/team/3.png" alt="..." />
                        <div class="caption">
                            <h4>olius lisa</h4>
                            <h5>Manager</h5>
                            <ul class="list-inline row m0">
                ...
                <div class="col-sm-3">
                    <div class="thumbnail">
                        <img src="<%= this.Master.baseUrl %>images/team/4.png" alt="..." />
                        <div class="caption">
                            <h4>samuel burn</h4>
                            <h5>Employee</h5>
                            <ul class="list-inline row m0">
        ...
        <div class="container">
            ...
            <div class="row brands">
                <ul class="nav navbar-nav">
                    <li><a href="#">
                        <img src="<%= this.Master.baseUrl %>images/clients/1.png" alt=""/></a></li>
                    <li><a href="#">
                        <img src="<%= this.Master.baseUrl %>images/clients/2.png" alt=""/></a></li>
                    <li><a href="#">
                        <img src="<%= this.Master.baseUrl %>images/clients/3.png" alt=""/></a></li>
                    <li><a href="#">
                        <img src="<%= this.Master.baseUrl %>images/clients/4.png" alt=""/></a></li>
                    <li><a href="#">
                        <img src="<%= this.Master.baseUrl %>images/clients/5.png" alt=""/></a></li>
                    <li><a href="#">
                        <img src="<%= this.Master.baseUrl %>images/clients/2.png" alt=""/></a></li>
                </ul>
            </div>
