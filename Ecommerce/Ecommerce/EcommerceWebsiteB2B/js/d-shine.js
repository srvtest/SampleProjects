...
$("#testiTab li").each(function(){
    ...
    /*----------------------------------------------------*/
        $('.spinner .btn:first-of-type').on('click', function () {
           var input = $(this).closest('.spinner').children('input.form-control');
           var hdnInput = $(this).closest('.spinner').children('input[type=hidden]');
           input.val(parseInt(hdnInput.val(), 10) + 1);
           hdnInput.val(input.val());
        //$('.spinner input').val( parseInt($('.spinner input').val(), 10) + 1);
    });
        $('.spinner .btn:last-of-type').on('click', function () {
           var input = $(this).closest('.spinner').children('input.form-control');
           var hdnInput = $(this).closest('.spinner').children('input[type=hidden]');
           if (parseInt(hdnInput.val(), 10) > 1) {
               input.val(parseInt(hdnInput.val(), 10) - 1);
               hdnInput.val(input.val());
           }
        //$('.spinner input').val( parseInt($('.spinner input').val(), 10) - 1);
