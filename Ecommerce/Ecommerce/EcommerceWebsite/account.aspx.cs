...
namespace EcommerceWebsite
{
    public partial class account : System.Web.UI.Page
    {
        ...
        protected void btnSaveAddress_Click(object sender, EventArgs e)
        {
            ...
            objCustomerAddr.CountryName = btn.Text;
        ...
        protected void btnSetDefault_Click(object sender, EventArgs e)
        {
            ...
            GetAllAddress(Convert.ToInt32(CommonControl.Decrypt(Convert.ToString(Session["CustomerId"]))));
        }
        ...
        protected void rptOrder_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            if (ds != null)
            {
                ...
                if (ds.Tables.Count > 2 && ds.Tables[2].Rows.Count > 0)
                {
                    ...
                    lblDiscount.Text = Convert.ToString(ds.Tables[2].Rows[0]["Discount"]);
                    lblVat.Text = Convert.ToString(ShippingCharges);
                    lblPurchasePrice.Text = Convert.ToString(PurchasePrice + ShippingCharges);
                    //}                    
