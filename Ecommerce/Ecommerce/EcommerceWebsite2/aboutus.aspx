<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="aboutus.aspx.cs" Inherits="EcommerceWebsite2.aboutus" %>
                    ...
                    <asp:Repeater ID="lstAboutUs" runat="server">
                        ...
                        <ItemTemplate>
                            <div class="about-content">
                                ...
                                <h5 class="about-sub-title">Founded in 1986, I.D. Jewelry, LLC, a family owned & operated business has become a house-hold name in states all over the USA as well as countries all over the world.
                            </h5>
                                <p>
                                    <%#Eval("sContent")%>
                                </p>
