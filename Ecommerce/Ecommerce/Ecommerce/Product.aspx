        ...
        <div class="card shadow mb-4" runat="server" id="frmProduct">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <label>Color</label>
                        <asp:DropDownList ID="ddlColor" class="form-control form-control-user" runat="server" EnableViewState="true"></asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" CssClass="fontcolour" ControlToValidate="ddlColor" runat="server" ErrorMessage="Please Select Color" ValidationGroup="save"></asp:RequiredFieldValidator>
                    </div>
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <label>Size</label>
                        <asp:DropDownList ID="ddlSize" class="form-control form-control-user" runat="server" EnableViewState="true"></asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" CssClass="fontcolour" ControlToValidate="ddlSize" runat="server" ErrorMessage="Please Select Size" ValidationGroup="save"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <label>Shape</label>
                        <asp:DropDownList ID="ddlShape" class="form-control form-control-user" runat="server" EnableViewState="true"></asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator12" CssClass="fontcolour" ControlToValidate="ddlShape" runat="server" ErrorMessage="Please Select Shape" ValidationGroup="save"></asp:RequiredFieldValidator>
                    </div>
                  <%--  <div class="col-sm-6 mb-3 mb-sm-0">
                        <label>Similer Product</label>
                        <asp:TextBox ID="txtSearch" runat="server" ClientIDMode="Static" />
                        <asp:HiddenField ID="hfSimilerId" runat="server" />
                    </div>--%>
                ...
                <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <label>Feature</label>
                        <asp:TextBox ID="txtFeature" runat="server" class="form-control form-control-user ckeditor" placeholder="Feature" Rows="7" TextMode="MultiLine"></asp:TextBox>
                ...
                <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <asp:TextBox ID="txtVideoName" class="form-control form-control-user" runat="server" ClientIDMode="Static"></asp:TextBox>
                    ...
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <asp:TextBox ID="txtVideoUrl" class="form-control form-control-user" runat="server" ClientIDMode="Static"></asp:TextBox>
        ...
        $(function () {
            $("[id$=txtSearch]").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/Product.aspx/GetProducts") %>',
