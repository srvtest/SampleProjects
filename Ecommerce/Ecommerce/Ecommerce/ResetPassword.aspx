<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="Ecommerce.ResetPassword" %>
                            ...
                            <div class="p-5">
                                ...
                                <div class="user">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <asp:TextBox ID="txtRepeatPassword" runat="server" type="password" class="form-control form-control-user" placeholder="Repeat Password"></asp:TextBox>
                                        </div>
                                    </div>
