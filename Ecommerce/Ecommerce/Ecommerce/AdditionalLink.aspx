                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="CatDelete" CssClass="btn btn-danger btn-circle btn-sm" CommandArgument='<%#Eval("idAdditionalLink") %>' OnClientClick="return confirm('Are you sure you want to delete.');"><i class="fas fa-trash"></i></asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
