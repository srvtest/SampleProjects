<%@ Page Title="" Language="C#" MasterPageFile="~/mainmaster.Master" AutoEventWireup="true" CodeBehind="ReportCustomer.aspx.cs" Inherits="Ecommerce.ReportCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        ...
        <p class="mb-4">Report Customer description</p>
                    ...
                    <asp:Repeater ID="lstReport" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="lblName" runat="server" ClientIDMode="Static" Text='<%#Eval("cName")%>'></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="lblCountry" runat="server" ClientIDMode="Static" Text='<%#Eval("CountryName")%>'></asp:Label>
                                </td>
                                <%--  <td>
                                    <asp:Label ID="lblValue" runat="server" ClientIDMode="Static" Text='<%#Eval("dtOrder")%>'></asp:Label>
                                </td>--%>
                                <td>
                                    <asp:Label ID="lblTotalOrder" runat="server" ClientIDMode="Static" Text='<%#Eval("totalOrder")%>'></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="lblTotalRevenue" runat="server" ClientIDMode="Static" Text='<%#Eval("totalRevenue")%>'></asp:Label>
                                </td>
                                <%--  <asp:HiddenField ID="hdnId" runat="server" Value='<%#Eval("idCustomer") %>' />  --%>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
                            </tbody>
